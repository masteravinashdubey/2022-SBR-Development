...
/** Offset Values for set point **/

float GyroXoffset = -1.80;  // -2.78
float GyroYoffset = 0.67;   // 0.67
float GyroZoffset = -0.20;  // -0.20
float AccXoffset = 0.10;   // -0.02
float AccYoffset = -0.01;   // -0.01
float AccZoffset = 0.09;    // 0.09
